...
st.markdown("Monitoramento de experimentos, versionamento de hiperparâmetros e registro de modelos utilizando **MLflow**.")
...
st.info("Na infraestrutura em Cloud ou Local, acessar http://localhost:5000 exibe o painel oficial do MLflow com os gráficos interativos de cada step das épocas (Loss vs Epoch).")
